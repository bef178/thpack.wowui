IntRangeExtension = (function()
    local IntRangeExtension = {}

    function IntRangeExtension.getIntIntersection(a1, a2, b1, b2)
    ...
    function IntRangeExtension.getIntSubstraction(a1, a2, b1, b2)
    ...
    function IntRangeExtension.getIntersection(r1, r2)
        return IntRangeExtension.op(IntRangeExtension.getIntIntersection, r1, r2)
    end

    function IntRangeExtension.getSubstraction(r1, r2)
        return IntRangeExtension.op(IntRangeExtension.getIntSubstraction, r1, r2)
    end

    function IntRangeExtension.op(op, r1, r2)
        local ranges = {}
        for i = 1, table.getn(r1), 2 do
