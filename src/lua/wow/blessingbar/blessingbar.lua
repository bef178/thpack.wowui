...
local getUnitDebuff = UnitUtil.getUnitDebuff
...
function blessingSlotMan:buildSlotModel(blessing, greatBlessing)
    ...
    blessing = blessing and getPlayerSpell(blessing)
    if not blessing then
        return
    end

    greatBlessing = greatBlessing and getPlayerSpell(greatBlessing)
...
blessingSlotMan:start(blessings)
