...
local function createShowHatCheckbox(parentFrame)
...
local function createShowCloakCheckbox(parentFrame)
    local f = createCheckboxWithLabel(parentFrame)
...
local function createCheckboxes(modelFrame)
    local f = createShowHatCheckbox(modelFrame)
    f:SetPoint("TOPLEFT", modelFrame, "TOPLEFT", 3, -35)

    local f1 = createShowCloakCheckbox(modelFrame)
    f1:SetPoint("TOPLEFT", f, "BOTTOMLEFT", 0, 0)
end

(function()
    createCheckboxes(CharacterModelFrame)
    -- createCheckboxes(AuctionDressUpModel)
    -- createCheckboxes(TabardCharacterModel)
end)()
