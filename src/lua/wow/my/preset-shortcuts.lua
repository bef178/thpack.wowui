...
(function()
    addSlashCommand("aLoadPresetShortcuts", "/loadpresetshortcuts", function()
        loadPresetKeyBindings(getPresetKeyBindings())
        logi("Preset keys loaded.")
    ...
    f:SetScript("OnEvent", function()
        ...
        f:Hide()
        logi("To load preset shortcuts, type \"/loadpresetshortcuts\".")
    end)
