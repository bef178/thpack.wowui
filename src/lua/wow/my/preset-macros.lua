...
local checkPlayerAttacking = UnitUtil.checkPlayerAttacking

startAttacking = function(b)
    if b == nil then
        b = true
    end
...
(function()
    addSlashCommand("aLoadPresetMacros", "/loadpresetmacros", function(x)
        loadPresetMacros(true)
        logi("Preset macros loaded.")
    end)
    ...
    f:SetScript("OnEvent", function()
        ...
        f:Hide()
        logi("To load preset macros, type \"/loadpresetmacros\".")
    end)
