...
f:SetScript("OnEvent", function()
    if event == "DISPLAY_SIZE_CHANGED" then
        ...
        logi(string.format("PixelPerfect: resolution [%s] detected.", clientResolution))
        ...
        if scale then
            ...
            logi(string.format("PixelPerfect: setting scale to %.06f i.e. 1 point = %d pixel(s)", scale, pixelsPerPoint))
