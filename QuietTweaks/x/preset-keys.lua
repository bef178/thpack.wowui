local function getPresetKeyBindings()
    local bindings = {
...
local function loadPresetKeyBindings(presetKeyBindings)
...
(function()
    local presetKeyBindings = getPresetKeyBindings();

    A.addSlashCommand("aLoadPresetKeys", "/loadpresetkeys", function()
        loadPresetKeyBindings(presetKeyBindings);
        A.logi("Preset keys loaded.");
    ...
    f:SetScript("OnEvent", function()
        ...
        f:Hide();
        A.logi("To load preset keys, type \"/loadpresetkeys\".");
    end);
end)();
